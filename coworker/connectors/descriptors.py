...
DESCRIPTORS: list[ConnectorDescriptor] = [
    ...
    ConnectorDescriptor(
        ...
        title="Slack",
        icon="💬",
        blurb="Two-way messaging — use a manual Slack app (Socket Mode) or a configured connector relay.",
        auth="socket_app",
        two_way=True,
        channels=True,
        brand_color="#611f69",
    ...
    ConnectorDescriptor(
        ...
        instructions=[
            "Connect with the configured relay, or use manual credentials where available.",
