...
class SessionManager:
    ...
    def list_artifacts(self, session_id: str) -> list[dict[str, Any]]:
        ...
        # TCC prompt ("PAVii would like to access data from other apps") on every turn.
    ...
    def set_scratch_base(self, path: str) -> dict[str, Any]:
        ...
        created (default ~/PAVii). The raw value is stored so the UI shows it as entered;
