...
uploads):
    ...
    PAVii-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    PAVii-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    PAVii-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
    PAVii-linux-x64.AppImage.tar.gz(.sig)-> platforms["linux-x86_64"]
...
The desktop app finds this file through https://github.com/buckleson/Pavii/releases/latest/download/latest.json
...
ARTIFACTS = {
    "PAVii-macos-arm64.app.tar.gz": "darwin-aarch64",
    "PAVii-macos-x64.app.tar.gz": "darwin-x86_64",
    "PAVii-windows-setup.exe": "windows-x86_64",
    "PAVii-linux-x64.AppImage.tar.gz": "linux-x86_64",
}
