...
// reads as a screenshot of Slack), PAVii on the right (app tokens). Tabs
    ...
    <div className="mb-5" data-testid="slack-howitworks">
      <div className="flex items-baseline gap-2.5">
        <h3 className="text-[13.5px] font-semibold tracking-tight">
          Getting started with Slack &amp; PAVii
        </h3>
        <button
...
function SlackRail({ active }: { active: string }) {
  return (
    <div className="hiw-slrail">
      ...
      <div className="hiw-slnav"><span className="hiw-appav">PV</span>PAVii</div>
    </div>
  );
}
...
function PVWin({ children }: { children: React.ReactNode }) {
  return (
    <div className="hiw-win hiw-PV">
      <div className="hiw-PVtop">
        <span className="hiw-dots"><i /><i /><i /></span> PAVii
      </div>
      <div className="hiw-PVbody">{children}</div>
    </div>
  );
}

function PVRail({ hot, hotSub, glow }: { hot?: string; hotSub?: string; glow?: boolean }) {
  return (
    <div className="hiw-PVrail">
      <div className="hiw-brand">PAVii</div>
...
function SceneMention({ meFirst, meInitial }: { meFirst: string; meInitial: string }) {
  return (
    <>
            ...
            <Msg
              ...
              extra={
                <span className="hiw-replybar hiw-k" style={d("4.6s")}>
                  <span className="hiw-sav2">PV</span> 1 reply
      ...
      <PVWin>
        <PVRail hot="Summarize #launch-room" hotSub="via Slack · now" glow />
        <div className="hiw-PVmain">
          <div className="hiw-PVtitle hiw-k" style={d("2.6s")}>
          ...
          <div className="hiw-PVcomposer">Message PAVii…</div>
        </div>
      </PVWin>
    </>
  );
            ...
            <Msg
              ...
              extra={
                <span className="hiw-replybar">
                  <span className="hiw-sav2">PV</span> 2 replies
...
function SceneTeammates() {
  return (
    <>
      ...
      <PVWin>
        <PVRail hot="Summarize #launch-room" hotSub="via Slack" />
        <div className="hiw-PVmain">
          <div className="hiw-PVtitle">Slack — {WS_NAME}</div>
