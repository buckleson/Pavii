    ...
    <Shell>
      <div className="flex items-start gap-3">
        <div className="flex-1 min-w-0">
          <PanelHead title="Automations" sub="Recurring tasks PAVii runs on a schedule." />
        </div>
        <button
      ...
      <div className="text-[12px] text-faint flex gap-1.5 mb-4">
        ...
        <span>
          Runs only while PAVii is running — a missed schedule catches up once when it next
          starts.
        </span>
      </div>
      ...
      {empty ? (
        !showForm && (
          <div className={CARD + " p-4 text-[12.5px] text-muted"}>
            ...
            or just ask PAVii in a session.
          </div>
        )
      ) : (
