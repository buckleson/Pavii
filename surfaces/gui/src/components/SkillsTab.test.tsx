...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with PAVii hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with PAVii"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask PAVii to revise")).toBeNull();
