...
function VoiceInputSection() {
  ...
  return (
    <section>
      ...
      {!desktop ? (
        <div className={CARD + " p-4 text-[13px] text-muted"}>Voice Input setup is available in the PAVii desktop app.</div>
      ) : (
...
function AppearanceSection() {
  ...
  return (
    <section>
      <PanelHead title="General" sub="How PAVii looks and behaves on this machine." />
        ...
        <div className={CARD + " p-4"}>
          ...
          <label className="flex items-start gap-3 py-2">
            ...
            <span>
              ...
              <span className="block text-[12px] text-muted">Launch PAVii automatically when you sign in.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 py-2">
        ...
        <span className="text-[12px] text-muted">
          {state === "none"
            ...
            : state === "error"
              ...
              : "Downloading — PAVii restarts by itself when it's ready."}
        </span>
      )}
    </span>
  );
