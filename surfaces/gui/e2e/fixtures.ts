...
const PINNED_SESSION = {
  ...
  workspace: "/Users/test/PAVii/launch-note",
  agent: "cowork",
  model: "anthropic:claude-opus-4-8",
  mode: "interactive",
...
const OPS_SESSION = {
  session_id: "ops-1",
  title: "Ops triage",
  workspace: "/Users/test/PAVii/ops-triage",
  agent: "ops",
  model: "anthropic:claude-opus-4-8",
  mode: "interactive",
...
const PRIMARY_ROOT = { path: "/Users/test/PAVii/launch-note", writable: true, label: "scratch", primary: true, exists: true };
