...
test.skip(true, 'PAVii Phase 1 skips one-click relay-only specs until connector relay UX is finalized');
...
async function signIn(page) {
  // Product account sign-in was removed; connector relay tests connect directly.
}
